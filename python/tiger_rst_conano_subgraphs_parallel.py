...
from discoursekernels.subgraph_enumeration import enumerate_all_subgraphs_upto_size_k_parallel
...
if __name__ == '__main__':
    ...
    subgraphs = enumerate_all_subgraphs_upto_size_k_parallel(merged_graph, int(k_str), 4)
